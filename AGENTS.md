...
- Use plain, straightforward English in all output - docs, comments, code, and chat. Avoid unusual or formal words when a common one works (e.g. avoid "invariants", "regressed", "underspecified", "mint", "churns"). Exception: creative or marketing copy when explicitly asked.
