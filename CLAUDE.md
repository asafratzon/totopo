# CLAUDE.md — totopo session instructions

## Every session start

1. Read this file
2. Read `docs/WORK.md` → summarise where we left off and what comes next, ask before starting
   - If `WORK.md` missing: read `README.md` + `docs/VISION.md`, propose breakdown, wait for approval

## Every session end

Update `docs/WORK.md` (check off done items, add discovered sub-tasks), commit, send checkpoint message.
